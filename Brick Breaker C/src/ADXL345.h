...
/* The span that we need to MMAP. 0xff800000 - 0xffffffff */
#define HW_REGS_BASE ( 0xffc00000 )
...
#define I2C0_CON                (0xffc04000)
#define I2C0_TAR                (0xffc04004)
#define I2C0_DATA_CMD           (0xffc04010)
#define I2C0_SS_SCL_HCNT        (0xffc04014)
#define I2C0_SS_SCL_LCNT        (0xffc04028)
#define I2C0_FS_SCL_HCNT        (0xffc0401c)
#define I2C0_FS_SCL_LCNT        (0xffc04020)
#define I2C0_INTR_MASK          (0xffc04030)
#define I2C0_CLR_INTR           (0xffc04040)
#define I2C0_TX_ABRT            (0xffc04054)
#define I2C0_ENABLE             (0xffc0406c)
#define I2C0_STATUS             (0xffc04070)
#define I2C0_TXFLR              (0xffc04074)
#define I2C0_RXFLR              (0xffc04078)
#define I2C0_TX_ABRT_SOURCE     (0xffc04080)
#define I2C0_ENABLE_STATUS      (0xffc0409c)
...
#define SYSMGR_GENERALIO7       (0xffd0849C)
/* GENERALIO8 (trace_d7): 
...
#define SYSMGR_GENERALIO8       (0xffd084A0)
/* GPLMUX55 and GPLMUX56: 
    0 : LoanIO. 
    1 : GPIO. */
#define SYSMGR_GPLMUX55         (0xffd086B0)
#define SYSMGR_GPLMUX56         (0xffd086B4)
/* I2C0USEFPGA: 
    0 : I2C0 uses HPS Pins. 
    1 : I2C0 uses the FPGA Inteface. */
#define SYSMGR_I2C0USEFPGA      (0xffd08704)
...
// Gain access to physical addresses using mmap
